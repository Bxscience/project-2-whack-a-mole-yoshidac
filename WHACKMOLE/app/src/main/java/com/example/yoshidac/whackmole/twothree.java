...
public class twothree extends AppCompatActivity {

    TextView timeText = findViewById(R.id.textView);
    TextView scoreText = findViewById(R.id.textView2);
    int score = 0;

    ImageButton[] imageButtons = {findViewById(R.id.imageButton), findViewById(R.id.imageButton2), findViewById(R.id.imageButton3), findViewById(R.id.imageButton4), findViewById(R.id.imageButton5), findViewById(R.id.imageButton6)};
    ...
    private void startfinish(){
        Intent intent = new Intent(twothree.this, finish.class);
